...
$post_set = find_posts_by_person($_SESSION['person_id']);
$person = find_person_by_id($_SESSION['person_id']);
...
if ( is_post_request() ) {
    ...
    if($action == "post_new"){
        $post = [];
        $post[ 'person_id' ] = $_SESSION[ 'person_id' ] ?? '';
        ...
        $result = delete_post_by_post_id_and_person_id( $post_id, $person_id  );
        if ( $result === true ) {
            $status = "Post removed.";
            redirect_to( url_for( 'home.php' ) );
        } else {
                ...
                <div class="modal-body-scroller">
                    <div class="media-list media-list-users list-group js-msgGroup">
                        <a href="#" class="list-group-item list-group-item-action">
                            <div class="media">
                                <img class="rounded-circle media-object d-flex align-self-start mr-3"
                    ...
                    <div class="d-none m-3 js-conversation">
                        <ul class="media-list media-list-conversation">
                            <li class="media media-current-user mb-4">
                                ...
                                <img class="rounded-circle media-object d-flex align-self-start ml-3"
                                     src="img/avatar-dhg.png">
                            </li>
            ...
            <div class="card card-profile mb-4">
                ...
                <div class="card-body text-center">
                    <a href="profile/index.html">
                        <img class="card-profile-img" src="avatar/<?php echo $person['profile_pic'] ?? ''; ?>">
                    </a>

                    <h6 class="card-title">
                        <a class="text-inherit"
                           href="profile/index.html"><?php echo $person['first_name'] ?? ''; ?> <?php echo $person['last_name'] ?? ''; ?></a>
            ...
            <div class="card d-md-block d-lg-block mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled list-spaced">
                        ...
                        <li><span class="text-muted icon icon-users mr-3"></span>Became friends with <a
                                    href="#">Obama</a>
        ...
        <div class="col-lg-8">
            ...
            <ul class="list-group media-list media-list-stream mb-4">
                ...
                <li class="media list-group-item p-4">
                    <form method="POST" action="home.php?action=post_new" style="width: 100%;">
                    <div class="input-group">
                        ...
                        <p class="help-block"><?php if(isset($errors['content'])){ display_error($errors['content']); } ?></p>
                ...
                <li class="media list-group-item p-4">
                    <img class="media-object d-flex align-self-start mr-3" src="avatar/<?php echo $person['profile_pic'] ?? ''; ?>">
                    <div class="media-body">
                        <div class="media-body-text">
                            <div class="media-heading">
                                <small class="float-right text-muted"><?php echo date("F j, Y g:i a", strtotime($post['datetime_posted'])); ?></small>
                                <h6><?php echo $person['first_name'] . " " . $person['last_name']; ?></h6>
                            </div>
                            <p>
                                <?php echo $post['content']; ?>
                            </p>
                            <p>
                                <form method="POST" action="home.php?action=post_delete&post_id=<?php echo $post['post_id'] ?? ''; ?>">
                                    <button type="submit" class="btn btn-secondary align-self-stretch">
                    ...
                    <div class="media-body">
                        <div class="media-body-text">
                            ...
                            <p>
                                ...
                                dapibus posuere velit aliquet. Cum sociis natoque penatibus et magnis dis parturient
                                montes, nascetur ridiculus mus. Morbi leo risus, porta ac consectetur ac, vestibulum at
                ...
                <li class="media list-group-item p-4">
                    ...
                    <div class="media-body">
                        ...
                        <div class="media-body-inline-grid" data-grid="images">
                            <img style="display: none" data-width="640" data-height="640" data-action="zoom"
