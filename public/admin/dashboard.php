...
$recent_persons_code = 0;
if(isset($_GET['recent_persons_code'])){
    $recent_persons_code = $_GET['recent_persons_code'];
}
$recent_persons_set = find_persons_created_on($recent_persons_code);
...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        <?php while ($person = mysqli_fetch_assoc($person_set)) { ?>
            <tr>
                ...
                <td>
                    <a href="person/view.php?person_id=<?php echo h(u($person['person_id'])); ?>">View</a> <span
                            class="pipe">|</span>
                    <a href="person/edit.php?person_id=<?php echo h(u($person['person_id'])); ?>">Edit</a> <span
                            class="pipe">|</span>
    ...
    <table class="table table-striped">
        ...
        <?php while ($organization = mysqli_fetch_assoc($organization_set)) { ?>
            <tr>
                ...
                <td>
                    <a href="organization_view.php?person_id=<?php echo h(u($organization['organization_id'])); ?>">View</a>
                    <span class="pipe">|</span>
                    <a href="organization_edit.php?person_id=<?php echo h(u($organization['organization_id'])); ?>">Edit</a>
                    <span class="pipe">|</span>
            ...
            <tr>
                ...
                <td>
                    <?php if (strlen($post['content']) > 50) {
                        echo substr(h($post['content']), 0, 50) . "...";
                    } else {
                        echo $post['content'];
                    } ?>
                </td>
                <td>
                    <a href="post/view.php?post_id=<?php echo h(u($post['post_id'])); ?>">View</a> <span
                            class="pipe">|</span>
                    <a href="post/edit.php?post_id=<?php echo h(u($post['post_id'])); ?>">Edit</a> <span
                            class="pipe">|</span>
    ...
    <h2 id="people" name="people">Analytics</h2>
    <h3 id="people" name="people">People</h3>
    <h4>New Accounts</h4>
        <p>
            <?php if($recent_persons_code == 0){
                echo "Today | ";
            }else{
                echo "<a href=\"dashboard.php?recent_persons_code=0#people\">Today</a> | ";
            } ?>

            <?php if($recent_persons_code == 1){
                echo "Last Week | ";
            }else{
                echo "<a href=\"dashboard.php?recent_persons_code=1#people\">Last Week</a> | ";
            } ?>

            <?php if($recent_persons_code == 2){
                echo "Last Month";
            }else{
                echo "<a href=\"dashboard.php?recent_persons_code=2#people\">Last Month</a>";
            } ?>
    ...
    <table class="table table-striped">
        ...
        <tbody>
        <?php while ($person = mysqli_fetch_assoc($recent_persons_set)) { ?>
            <tr>
                <td>
                    <?php echo h($person['first_name']); ?>
                </td>
